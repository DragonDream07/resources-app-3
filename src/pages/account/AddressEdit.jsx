...
export default function AddressEdit() {
    ...
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          ...
          <div style={{ ...styles.skeleton, height: '400px' }} />
        </div>
      </div>
    );
  }
  ...
  if (!form) {
    return (
      <div style={styles.page}>
        <div style={styles.container}>
          <div style={styles.errorBanner}>Address not found. <Link to="/account/addresses" style={{ color: '#f03e3e' }}>Back to addresses</Link></div>
        </div>
      </div>
    );
  }
